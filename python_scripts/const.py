...
GRAVITY = 9.8                    # [m/s^2]
CROSS_AREA_TURBINE_SMALL = 1     # [m^2]
CROSS_AREA_TURBINE_LARGE = 25    # [m^2]
...
WIDTH_OF_GENERATOR = 1           # [m]
DISTANCE_LIMIT = 5000            # [m] distance limit of the power plant away from shore
